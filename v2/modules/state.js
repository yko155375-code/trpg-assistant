...
export function normalizeState(input) {
  ...
  const characters = normalizeCharacters(recordArray(source.characters).map(sanitizeCharacter));
  ...
  return {
    ...fallback,
    ...source,
    meta: { ...fallback.meta, ...sourceMeta, version: APP_VERSION },
    ...
    shop: normalizeShop({
      ...fallback.shop,
      ...sourceShop,
      items: recordArray(sourceShop.items),
      purchaseLog: recordArray(sourceShop.purchaseLog),
    }),
    rolls: recordArray(source.rolls),
    audio: { ...fallback.audio, ...sourceAudio },
    ui: {
      ...fallback.ui,
      ...sourceUi,
      currentCharacterId,
      ...
      rollFormulaDrafts: isRecord(sourceUi.rollFormulaDrafts) ? sourceUi.rollFormulaDrafts : {},
